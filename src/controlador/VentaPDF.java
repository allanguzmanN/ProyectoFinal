...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            Image img = Image.getInstance("src/img/elitecomercce.png");
            ...
            String ruc = "2210122221";
            String nombre = "EliteCommerce";
            String telefono = "2643-2109";
            String direccion = "Santa Barbara";
           

            Encabezado.addCell("");//celda vacia
            Encabezado.addCell("RTN: " + ruc + "\nNOMBRE: " + nombre + "\nTELEFONO: " + telefono + "\nDIRECCION: " + direccion );
